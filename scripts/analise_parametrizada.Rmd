...
base_analise <- dados %>% 
  filter(ifelse(params$uf_tratado == "Amapá"), between( id_municipio_6, 110000, 199999),
         ifelse(which(params$uf_tratado == "Ceará" |params$uf_tratado == "Pernambuco")), between( id_municipio_6, 210000, 299999), ano == 2020)
